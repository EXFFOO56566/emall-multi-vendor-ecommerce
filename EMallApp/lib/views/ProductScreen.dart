...
class _ProductScreenState extends State<ProductScreen> {
  ...
  _addInCart() async {
    ...
    MyResponse myResponse = await CartController.addIntoCart(product.id,product.productItems[selectedItem].id);
  ...
  List<Widget> _buildPageIndicatorAnimated(int totalPages,
      ThemeData themeData) {
    List<Widget> list = [];
    if (totalPages > 1) {
      ...
      for (int i = 0; i < totalPages; i++) {
        list.add(i == _currentPage ? _indicator(true, themeData) : _indicator(
            false, themeData));
      }
    } else {
      list.add(Container());
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: ProductUtils.singleProductItemOption(product.productItems[selectedItem],themeData,customAppTheme),
            ),
          ),
          PopupMenuButton(
              ...
              for (int i = 0; i < product.productItems.length; i++) {
                ...
                list.add(PopupMenuItem(
                  ...
                  child: Container(
                    ...
                    child: ProductUtils.singleProductItemOption(product.productItems[i],themeData,customAppTheme)
                  ),
                ));
                list.add(
                  PopupMenuDivider(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Product.offerTextWidget(
                              originalPrice: product.productItems[selectedItem].price.toDouble(),
                              offer: product.offer,
                              fontSize: 20,
                              customAppTheme: customAppTheme,
                              themeData: themeData)),
                          ...
                          child: Text(
                            CurrencyApi.getSign(afterSpace: true) +
                                Product.getOfferedPrice(
                                        product.productItems[selectedItem].price.toDouble(), product.offer)
                                    .toString(),
                            style: AppTheme.getTextStyle(
