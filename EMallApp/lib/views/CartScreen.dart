...
class _CartScreenState extends State<CartScreen> {
  ...
  _buildBody() {
    if (customCarts.length != 0) {
      ...
      return LoadingScreens.getCartLoadingScreen(context, themeData, customAppTheme);
    } else {
      return Container(
                  ...
                  children: <Widget>[
                    Text(cart.product.name,
                        style: AppTheme.getTextStyle(
                            ...
                            letterSpacing: 0)),
                    Text(
                      CurrencyApi.getSign(afterSpace: true) + CurrencyApi.doubleToString(Product.getOfferedPrice(cart.productItem.price.toDouble(), cart.product.offer)),
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            InkWell(
                              ...
                              child: Container(margin: Spacing.horizontal(12),
                                   child: Icon(MdiIcons.deleteOutline,color: themeData.colorScheme.primary,)),
                            ),
                            InkWell(
                              onTap: () {
