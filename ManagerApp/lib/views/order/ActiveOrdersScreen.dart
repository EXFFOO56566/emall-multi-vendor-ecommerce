...
import 'package:ManagerApp/views/order/SingleOrderScreen.dart';
...
class ActiveOrdersScreen extends StatefulWidget {
  ...
  const ActiveOrdersScreen(
      {Key key, this.orders, this.rootContext})
      : super(key: key);
...
class _ActiveOrdersScreenState extends State<ActiveOrdersScreen> {
  ...
  _buildBody() {
    if (orders.length != 0) {
      ...
      return Center(
          child: Text(Translator.translate("you_have_not_any_active_orders")));
    }
  }
