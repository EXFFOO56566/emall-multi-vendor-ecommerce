...
import 'package:ManagerApp/models/Manager.dart';
import 'package:ManagerApp/models/MyResponse.dart';
import 'package:ManagerApp/services/PushNotificationsManager.dart';
...
class AuthController {
  ...
  static Future<MyResponse> registerUser(
    ...
    //Body
    Map data = {'name': name, 'email': email, 'password': password,'fcm_token':fcmToken};
